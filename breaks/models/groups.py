...
class Group(models.Model):
    organization = models.ForeignKey('breaks.Organization', models.CASCADE, 'groups', verbose_name="Организация")
    name = models.CharField('Название', max_length=255)
    manager = models.ForeignKey(User, models.RESTRICT, 'group_manager', verbose_name='Менеджер')
